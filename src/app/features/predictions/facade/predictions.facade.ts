...
export class PredictionFacade {
  ...
  createPrediction(prediction: SeasonPrediction) {
    ...
    return this.predictionService.saveCurrentPrediction(request).pipe(
      tap((response) => {
        if (!response) {
          return;
        }
      ...
      catchError((error) => {
        this.notificationService.errorMessage('Error', 'No se pudieron guardar tus predicciones.');
  ...
  updatePrediction(prediction: SeasonPrediction) {
    ...
    return this.predictionService.updateCurrentPrediction(request).pipe(
      tap((response) => {
      ...
      catchError((error) => {
        this.notificationService.errorMessage('Error', 'No se pudieron guardar tus cambios.');
