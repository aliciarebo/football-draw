...
export class SeasonResultService {
  ...
  getSeasonResults() {
    return this.http.get<SeasonResultsResponse | null>(this.apiUrl);
  }

  createSeasonResults(request: SeasonResultsRequest) {
    return this.http.post<SeasonResultsResponse>(this.apiUrl, request);
  }

  updateSeasonResults(request: SeasonResultsRequest) {
    return this.http.put<SeasonResultsResponse>(this.apiUrl, request);
  }
}
